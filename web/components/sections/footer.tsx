...
const footerLinks = {
  ...
  resources: [
    ...
    { label: 'GitHub', href: 'https://github.com/peavey2787/KaspaKinesis', external: true },
    { label: 'README', href: 'https://github.com/peavey2787/KaspaKinesis#readme', external: true },
  ],
  community: [
    { label: 'Twitter', href: 'https://x.com/kaspa_kinesis', external: true },
    { label: 'Discord', href: 'https://discord.gg/KczWtgdz8y', external: true },
    { label: 'Contact', href: 'mailto:peavey2787@yahoo.com', external: true },
  ],
}

const socialLinks = [
  { icon: Github, href: 'https://github.com/peavey2787/KaspaKinesis', label: 'GitHub' },
  { icon: Twitter, href: 'https://x.com/kaspa_kinesis', label: 'Twitter' },
  { icon: Mail, href: 'mailto:peavey2787@yahoo.com', label: 'Email' },
]

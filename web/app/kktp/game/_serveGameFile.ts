...
const BASE_DIR = path.resolve(process.cwd(), 'kktp', 'game')
...
export async function serveGameFile(_req: NextRequest, segments: string[]) {
  const requestedAbs = resolveSafePath(segments.length ? segments : ['index.html'])
  ...
  try {
    ...
    return new Response(data, {
      ...
      headers: {
        ...
        // This is a dev/demo asset server; keep caching conservative.

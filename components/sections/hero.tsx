    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 pt-20">
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            <span className="gradient-text text-glow">ꓘK</span>{' '}
          ...
          >
            ...
            <span className="text-kaspa-primary">Decentralized Networking</span>
          </motion.p>
          ...
          >
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-sm text-muted-foreground/60 mt-2">3-minute walkthrough of ꓘK capabilities</p>
              </div>
            </div>
          </motion.div>
        </motion.div>

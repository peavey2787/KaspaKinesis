...
const faqs = [
  {
    ...
    answer: `No, ꓘK is not a full-featured game engine like Unity or Unreal. It's a specialized infrastructure layer that provides provable randomness and decentralized networking for multiplayer games. You would use ꓘK alongside your existing game framework to handle entropy, state synchronization, and peer connectivity. Think of it as the "fair play" backbone for your game.`,
  },
  {
    question: 'Do I need to run servers?',
    answer: `No! That's one of the key innovations. ꓘK uses the Kaspa BlockDAG as both a source of randomness and a relay layer for peer discovery. Players connect directly to each other via WebRTC, with the DAG handling the signaling. There are no game servers to maintain, scale, or pay for. The only infrastructure you need is already running: the Kaspa network itself.`,
  },
  {
    question: 'How is randomness provable?',
    answer: `Every random number generated by ꓘK can be traced back to specific Kaspa blocks. The Recursive Folding algorithm takes block hashes and nonces (which are products of real mining work) and transforms them into uniform random values. Since all inputs are public blockchain data, anyone can verify that the randomness wasn't manipulated. We also run NIST SP 800-22 statistical tests to prove the quality meets cryptographic standards.`,
  },
  {
  ...
  },
  {
    ...
    answer: `Most blockchain games put game logic on-chain, which is slow and expensive. ꓘK takes a different approach: the blockchain provides entropy and relay services, but game logic runs locally on each player's device. This gives you blockchain-grade fairness with traditional game performance. You get the best of both worlds without the gas fees or latency of on-chain execution.`,
  },
  {
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <ScrollReveal delay={0.2} className="mt-12 text-center">
          <p className="text-muted-foreground">
            Still have questions?{' '}
            <a href="mailto:hello@kaspakinesis.io" className="text-primary hover:underline">
              Reach out directly
            </a>{' '}
            or{' '}

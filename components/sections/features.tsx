...
const features = [
  ...
  },
  {
    ...
    description: 'Any observer can join mid-session and catch up by replaying anchored state. Full transparency for esports, audits, or debugging.',
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
        <ScrollReveal className="text-center mb-16">
          ...
          <p className="section-subtitle mx-auto">
            Six foundational primitives that make ꓘK possible. Each component is 
            designed for transparency, auditability, and decentralization.
          </p>
        </ScrollReveal>

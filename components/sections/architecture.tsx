...
import { 
  Layers, Shuffle, Radio, Database, 
  ChevronRight, Box, ArrowRight, Circle,
    ...
    <div className="relative py-8">
      ...
      <div className="flex flex-col lg:flex-row items-center justify-center gap-4 lg:gap-8">
        ...
        <motion.div
          ...
          className="glass p-6 rounded-xl border border-neon-purple/30 text-center"
        >
          <div className="w-16 h-16 mx-auto mb-3 rounded-full bg-gradient-to-br from-neon-purple to-pink-500 flex items-center justify-center">
            <GitBranch className="w-8 h-8 text-background" />
          </div>
          <h4 className="font-semibold text-foreground">BlockDAG</h4>
          <p className="text-sm text-muted-foreground mt-1">Kaspa Network</p>
        </motion.div>
      </div>
      ...
      >
        <h4 className="text-lg font-semibold mb-4 text-center">Entropy Pipeline</h4>
        <div className="flex flex-wrap items-center justify-center gap-2 lg:gap-4 text-sm">
          ...
          <ChevronRight className="w-4 h-4 text-muted-foreground" />
          <span className="tag bg-gradient-to-r from-neon-cyan/20 to-neon-green/20 border-primary/40">Game State</span>
        </div>
      </motion.div>
  ...
  return (
    <div className="py-8 space-y-8">
      <div className="text-center max-w-2xl mx-auto">
        <h4 className="text-xl font-semibold mb-3">Cryptographic Entropy Whitening</h4>
        <p className="text-muted-foreground">
          Recursive Folding takes raw PoW data from Kaspa blocks and applies iterative 
          cryptographic mixing to produce statistically uniform, NIST-compliant random numbers.
        </p>
      </div>
      ...
      <div className="relative">
        ...
        <div className="space-y-6 lg:space-y-0 lg:grid lg:grid-cols-2 lg:gap-8">
          {[
            { title: 'Block Header Hash', desc: 'Extract hash from Kaspa block header', step: 1 },
            { title: 'Nonce Extraction', desc: 'Pull PoW nonce value', step: 2 },
            { title: 'Recursive Mixing', desc: 'Apply iterative hash folding', step: 3 },
            { title: 'Statistical Whitening', desc: 'Remove bias through XOR operations', step: 4 },
            { title: 'NIST Validation', desc: 'Run SP 800-22 test battery', step: 5 },
            { title: 'VRF Output', desc: 'Produce verifiable random value', step: 6 },
          ].map((item, i) => (
            <motion.div
              key={i}
  ...
  return (
    <div className="py-8 space-y-8">
      <div className="text-center max-w-2xl mx-auto">
        ...
        <p className="text-muted-foreground">
          The Kaspa Relay uses the BlockDAG as a decentralized mailbox, enabling 
          peer discovery and NAT traversal without centralized infrastructure.
        </p>
      </div>
      ...
      <div className="relative py-12">
        <div className="flex justify-center items-center gap-4 lg:gap-16">
          ...
          >
            ...
            <svg className="absolute inset-0 w-full h-full pointer-events-none overflow-visible" style={{ left: '-50%', width: '200%' }}>
              <motion.path
      ...
      <div className="grid md:grid-cols-3 gap-4">
        {[
          { title: 'Post', desc: 'Player publishes connection intent to DAG' },
          { title: 'Discover', desc: 'Peers find each other through DAG queries' },
          { title: 'Connect', desc: 'Direct WebRTC connection established' },
        ].map((step, i) => (
          <motion.div
            key={i}
            initial={{ opacity: 0, y: 20 }}
...
function StateDiagram() {
  return (
    <div className="py-8 space-y-8">
      <div className="text-center max-w-2xl mx-auto">
        <h4 className="text-xl font-semibold mb-3">Deterministic State & Anchoring</h4>
        <p className="text-muted-foreground">
          Game state is fully deterministic. Given the same seed and action sequence, 
          any node can reconstruct the exact same state. Periodic anchoring to the DAG 
      ...
      >
        <h5 className="text-center font-semibold mb-6">Merkle-of-Merkles Structure</h5>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div className="glass p-6 rounded-xl border border-neon-cyan/30">
          <h5 className="font-semibold mb-3 text-neon-cyan">Periodic Anchoring</h5>
          ...
          <ul className="space-y-2 text-sm text-muted-foreground">
            <li>• Every N blocks or M actions</li>
            <li>• Merkle proof enables partial verification</li>
            <li>• Dispute resolution via on-chain data</li>
          </ul>
        </div>
        
        <div className="glass p-6 rounded-xl border border-neon-green/30">
          <h5 className="font-semibold mb-3 text-neon-green">Full Replayability</h5>
          <p className="text-sm text-muted-foreground mb-4">
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
        <ScrollReveal className="text-center mb-12">
          ...
          <h2 className="section-title mb-4">
            How <span className="gradient-text">ꓘK</span> Works
          </h2>
